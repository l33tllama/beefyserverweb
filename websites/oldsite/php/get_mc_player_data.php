<?php
$con = mysqli_connect("localhost", "mc_logger", "mc_logger1337", "minecraft_player_data");
// Check connection
if (mysqli_connect_errno($con)) {
	...
	$players_label_array = array("id" => "", "label" => "Players", "pattern" => "", "type" => "tooltip", "p" => array("role" => "tooltip", "html" => TRUE));
